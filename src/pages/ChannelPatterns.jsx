...
const CHANNELS = [
  ...
  { id:11, cat:'반전 패턴', name:'더블탑 / 더블바텀', signal:'neutral', desc:'두 개의 고점(탑) 또는 저점(바텀)이 같은 레벨에서 형성', structure:'더블탑: 두 고점 비슷 / 더블바텀: 두 저점 비슷', signalText:'더블탑: 지지 이탈 하락 / 더블바텀: 저항 돌파 상승', note:'아담&이브: 첫 번째 뾰족 + 두 번째 둥근 형태', keywords:['더블탑','더블바텀','이중천장','이중바닥','W형'] },
...
function ChannelSVG({ name }) {
  const shapes = {
    ...
    '불 플래그': <><line x1="8" y1="58" x2="28" y2="14" stroke={GREEN} strokeWidth="2.5" strokeLinecap="round"/><line x1="28" y1="14" x2="56" y2="14" stroke="#f0a040" strokeWidth="1.2"/><line x1="28" y1="28" x2="56" y2="28" stroke="#f0a040" strokeWidth="1.2"/><polyline points="28,14 36,27 44,14 52,27 56,18" fill="none" stroke="#4f8ef7" strokeWidth="1.2" strokeLinejoin="round"/><line x1="56" y1="18" x2="62" y2="6" stroke={GREEN} strokeWidth="1.8" strokeLinecap="round"/></>,
    '베어 플래그': <><line x1="8" y1="10" x2="28" y2="52" stroke={RED} strokeWidth="2.5" strokeLinecap="round"/><line x1="28" y1="38" x2="56" y2="38" stroke="#f0a040" strokeWidth="1.2"/><line x1="28" y1="52" x2="56" y2="52" stroke="#f0a040" strokeWidth="1.2"/><polyline points="28,52 36,39 44,52 52,39 56,48" fill="none" stroke="#4f8ef7" strokeWidth="1.2" strokeLinejoin="round"/><line x1="56" y1="48" x2="62" y2="62" stroke={RED} strokeWidth="1.8" strokeLinecap="round"/></>,
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{background:'rgba(0,0,0,0.6)'}} onClick={onClose}>
      <div className={`w-full max-w-lg rounded-2xl border p-6 ${bgC} max-h-[90vh] overflow-y-auto`} onClick={e => e.stopPropagation()}>
        ...
        <ChartNote page="channel" section={`channel_${item.id}`} label="예시 차트 사진" single={true} />
      </div>
    </div>
  )
}
