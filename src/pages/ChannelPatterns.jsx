...
/* ── SVG 컴포넌트 ── */
function ChannelSVG({ name, variant }) {
  const svgs = {

    /* 평행 채널 */
    '상승 채널': (
      <svg width="80" height="80" viewBox="-5 -5 295 305" fill="none">
        <line x1="197.99" y1="11.1213" x2="0.707138" y2="208.404" stroke={GREEN} strokeWidth="2"/>
        <line x1="239.002" y1="52.1335" x2="41.7193" y2="249.416" stroke={GREEN} strokeWidth="2" strokeDasharray="4 3"/>
        <line x1="280.014" y1="93.1457" x2="82.7316" y2="290.428" stroke={GREEN} strokeWidth="2"/>
        <path d="M89.5 278.914V167.414L139.5 208.914L146.86 60.1336L232 142.914L220.134 24.9142" stroke={GREEN} strokeWidth="2"/>
      </svg>
    ),
    '하락 채널': (
      <svg width="80" height="80" viewBox="345 -5 295 295" fill="none">
        <line x1="350.707" y1="82.7315" x2="547.99" y2="280.014" stroke={RED} strokeWidth="2"/>
        <line x1="391.719" y1="41.7193" x2="589.002" y2="239.002" stroke={RED} strokeWidth="2" strokeDasharray="4 3"/>
        <line x1="432.732" y1="0.707078" x2="630.014" y2="197.99" stroke={RED} strokeWidth="2"/>
        <path d="M443 10.4142L398 125.414H471.5L464 163.414L566 132.414L545 220.414H612.5" stroke={RED} strokeWidth="2"/>
      </svg>
    ),
    '횡보 채널': (
      <svg width="80" height="80" viewBox="708 55 290 140" fill="none">
        <line x1="991" y1="69.9142" x2="712" y2="69.9142" stroke={GRAY} strokeWidth="2"/>
        <line x1="991" y1="127.914" x2="712" y2="127.914" stroke={GRAY} strokeWidth="2" strokeDasharray="4 3"/>
        <line x1="991" y1="185.914" x2="712" y2="185.914" stroke={GRAY} strokeWidth="2"/>
        <path d="M719 185.914L741.5 69.4142C745.5 101.081 754.2 162.514 757 154.914C759.8 147.314 770.833 109.748 776 91.9142L792.5 178.914L813 69.4142L836.5 193.914L861.5 99.4142L879.5 161.914L903 56.4142L915 132.414L924.5 99.4142L943.5 169.414C945 156.748 948.5 132.814 950.5 138.414C952.5 144.014 964.667 183.414 970.5 202.414L977.5 132.414L987 76.9142L996.5 132.414" stroke={GRAY} strokeWidth="2"/>
      </svg>
    ),
    ...
    '어센딩 트라이앵글': (
      <svg width="80" height="70" viewBox="0 0 385 280" fill="none">
        <line x1="0.472046" y1="73.4135" x2="381.472" y2="73.4135" stroke={GREEN} strokeWidth="3"/>
        <line x1="0.236032" y1="277.473" x2="381.236" y2="73.4727" stroke={GREEN} strokeWidth="3"/>
        <path d="M12.972 272.413L49.972 73.4135L127.472 207.913L184.472 73.4135L245.472 144.913L285.972 73.4135L335.972 100.913" stroke={GREEN} strokeWidth="2.5"/>
      </svg>
    ),
    '디센딩 트라이앵글': (
      <svg width="80" height="70" viewBox="480 70 390 215" fill="none">
        <line x1="485.472" y1="277.413" x2="863.472" y2="277.413" stroke={RED} strokeWidth="3"/>
        <line x1="863.235" y1="278.353" x2="485.235" y2="74.3535" stroke={RED} strokeWidth="3"/>
        <path d="M516.472 89.9135L540.472 273.913L610.472 146.913L641.972 273.913L730.472 205.913L754.472 273.913" stroke={RED} strokeWidth="2.5"/>
      </svg>
    ),
    '대칭 삼각수렴': (
      <svg width="80" height="70" viewBox="893 0 292 230" fill="none">
        <line x1="896.676" y1="0.456745" x2="1181.68" y2="127.457" stroke={GRAY} strokeWidth="3"/>
        <line x1="1181.64" y1="128.385" x2="905.639" y2="226.385" stroke={GRAY} strokeWidth="3"/>
        <path d="M929.472 218.913L962.472 30.9135L1025.47 185.913L1071.47 74.9135L1109.97 152.413L1154.47 109.913" stroke={GRAY} strokeWidth="2.5"/>
      </svg>
    ),
    ...
    '하락 쐐기': (
      <svg width="100" height="80" viewBox="0 0 100 80" fill="none">
        {/* 상승중하락 (빨강→초록 반전) */}
        <svg x="0" y="0" width="42" height="80" viewBox="34 58 480 350">
          <line x1="89.8782" y1="58.8371" x2="441.878" y2="293.837" stroke={GREEN} strokeWidth="4"/>
          <line x1="34.3841" y1="250.598" x2="426.384" y2="377.598" stroke={GREEN} strokeWidth="4"/>
        ...
        {/* 슬래시 */}
        <line x1="48" y1="72" x2="52" y2="8" stroke={GRAY} strokeWidth="1" opacity="0.5"/>
        {/* 하락중하락 */}
        <svg x="56" y="0" width="44" height="80" viewBox="955 40 450 430">
          <line x1="974.74" y1="172.571" x2="1376.74" y2="62.5714" stroke={GREEN} strokeWidth="4"/>
          <line x1="995.248" y1="377.78" x2="1395.25" y2="140.78" stroke={GREEN} strokeWidth="4"/>
    ...
    '상승 쐐기': (
      <svg width="100" height="80" viewBox="0 0 100 80" fill="none">
        {/* 상승중상승 */}
        <svg x="0" y="0" width="42" height="80" viewBox="470 50 440 380">
          <line x1="490.74" y1="203.571" x2="892.74" y2="93.5714" stroke={RED} strokeWidth="4"/>
          <line x1="511.248" y1="408.78" x2="911.248" y2="171.78" stroke={RED} strokeWidth="4"/>
        ...
        <svg x="56" y="0" width="44" height="80" viewBox="1450 0 450 456">
          <line x1="1532.88" y1="62.8371" x2="1884.88" y2="297.837" stroke={RED} strokeWidth="4"/>
          <line x1="1477.38" y1="254.598" x2="1869.38" y2="381.598" stroke={RED} strokeWidth="4"/>
    ...
    '헤드앤숄더': (
      <svg width="100" height="70" viewBox="-5 45 415 370" fill="none">
        <line x1="0" y1="304" x2="400" y2="304" stroke={GRAY} strokeWidth="1.5" strokeDasharray="4 3"/>
    ...
    '역헤드앤숄더': (
      <svg width="100" height="70" viewBox="525 -5 385 410" fill="none">
        <line x1="526" y1="71.0003" x2="901" y2="71.0003" stroke={GRAY} strokeWidth="1.5" strokeDasharray="4 3"/>
        <path d="M550 12.0003L548.064 12.5006L610.064 252.501L612 252L613.936 251.5L551.936 11.5001L550 12.0003ZM612 252L613.838 252.789L656.338 153.789L654.5 153L652.662 152.211L610.162 251.211L612 252ZM654.5 153L652.57 153.527L715.57 384.527L717.5 384L719.43 383.474L656.43 152.474L654.5 153ZM717.5 384L719.416 384.572L802.416 106.572L800.5 106L798.584 105.428L715.584 383.428L717.5 384ZM800.5 106L798.603 106.633L829.603 199.633L831.5 199L833.397 198.368L802.397 105.368L800.5 106ZM831.5 199L833.437 199.497L883.937 2.49695L882 2.00031L880.063 1.50368L829.563 198.504L831.5 199Z" fill={GREEN}/>
      </svg>
    ),
    '더블탑 / 더블바텀': (
      <svg width="80" height="70" viewBox="0 0 80 70" fill="none">
        {/* 더블탑 */}
        <polyline points="4,60 14,28 24,60 34,28 44,60" fill="none" stroke={RED} strokeWidth="1.8"/>
        <line x1="4" y1="28" x2="44" y2="28" stroke={RED} strokeWidth="1" strokeDasharray="3 2" opacity="0.7"/>
        {/* 더블바텀 */}
        <polyline points="40,14 50,46 60,14 70,46 80,14" fill="none" stroke={GREEN} strokeWidth="1.8"/>
        <line x1="40" y1="46" x2="80" y2="46" stroke={GREEN} strokeWidth="1" strokeDasharray="3 2" opacity="0.7"/>
      </svg>
    ),
    '아담과 이브': (
      <svg width="80" height="70" viewBox="0 0 80 70" fill="none">
        <polyline points="8,20 14,58 20,20" fill="none" stroke={GREEN} strokeWidth="2"/>
        <path d="M30 22 Q42 62 54 22" fill="none" stroke={GREEN} strokeWidth="2"/>
        <line x1="8" y1="22" x2="54" y2="22" stroke={GREEN} strokeWidth="1" strokeDasharray="3 2" opacity="0.5"/>
        <line x1="54" y1="22" x2="72" y2="8" stroke={GREEN} strokeWidth="1.8" strokeLinecap="round"/>
        <polygon points="72,8 66,12 69,17" fill={GREEN}/>
      </svg>
    ),
    ...
    '컵앤핸들': (
      <svg width="80" height="70" viewBox="0 0 80 70" xmlns="http://www.w3.org/2000/svg">
        <line x1="4" y1="12" x2="76" y2="12" stroke={GRAY} strokeWidth="1" strokeDasharray="3 2"/>
        <path d="M4 12 Q26 56 48 12" fill="none" stroke={GREEN} strokeWidth="1.8"/>
        <polyline points="48,12 56,24 64,16" fill="none" stroke={GREEN} strokeWidth="1.8"/>
        <line x1="64" y1="16" x2="76" y2="4" stroke={GREEN} strokeWidth="1.8" strokeLinecap="round"/>
        <polygon points="76,4 70,8 73,13" fill={GREEN}/>
      </svg>
    ),
  }

  return svgs[name] || <svg width="64" height="66"><line x1="8" y1="33" x2="56" y2="33" stroke={GRAY} strokeWidth="1.5"/></svg>
}
...
const CHANNELS = [
  ...
  { id:11, cat:'반전 패턴', name:'더블탑 / 더블바텀', signal:'both', desc:'두 개의 고점(탑) 또는 저점(바텀)이 같은 레벨에서 형성', structure:'더블탑: 두 고점 비슷 / 더블바텀: 두 저점 비슷', signalText:'더블탑: 지지 이탈 하락 / 더블바텀: 저항 돌파 상승', note:'넥라인 돌파/이탈 시 신뢰도 높음', keywords:['더블탑','더블바텀','이중천장','이중바닥','쌍바닥','W형'] },
  { id:12, cat:'반전 패턴', name:'아담과 이브', signal:'up', desc:'더블바텀 변형 — 첫 저점 뾰족(아담), 두 번째 저점 둥글고 완만(이브)', structure:'아담(뾰족한 저점) → 반등 → 이브(둥근 저점) → 상승', signalText:'이브 저점 형성 후 넥라인 돌파 시 강한 상승', note:'이브가 아담보다 살짝 높은 경우 신뢰도 높음', keywords:['아담이브','아담과이브','adam eve','더블바텀'] },
...
function WedgeModal({ item, onClose }) {
  ...
  const color = isDown ? GREEN : RED

  const variants = isDown
    ? [
        { label: '상승 중 하락', svgName: '상승중하락쐐기', viewBox: '34 58 480 350', desc: '상승 추세 중 나타나는 조정 구간 — 쐐기 돌파 후 상승 재개', signal: '저항선 상방 돌파 → 상승 재개', color: GREEN },
        { label: '하락 중 하락', svgName: '하락중하락쐐기', viewBox: '955 40 450 430', desc: '하락 추세 중 나타나는 하락 쐐기 — 강한 상승 반전 신호', signal: '저항선 상방 돌파 → 강한 상승 반전', color: GREEN },
      ]
    : [
        { label: '상승 중 상승', svgName: '상승중상승쐐기', viewBox: '470 50 440 380', desc: '상승 추세 중 나타나는 상승 쐐기 — 추세 소진 후 하락 반전', signal: '지지선 하방 이탈 → 하락 반전', color: RED },
        { label: '하락 중 상승', svgName: '하락중상승쐐기', viewBox: '1450 0 450 456', desc: '하락 추세 중 나타나는 반등 쐐기 — 하락 지속 신호', signal: '지지선 하방 이탈 → 하락 재개', color: RED },
      ]
          ...
          <div key={v.label}>
            ...
            <div className={`flex gap-4 p-4 rounded-xl mb-2 ${rowBg}`}>
              <div className="shrink-0 flex items-center">
                <svg width="72" height="72" viewBox={v.viewBox} fill="none">
                  {svgPaths[v.svgName]}
                </svg>
              </div>
              <div className="flex-1 space-y-2">
...
/* ── 더블탑/바텀 모달 ── */
function DoubleTBModal({ onClose }) {
  const { dark } = useTheme()
  ...
  const data = {
    top: {
      desc: '상승 추세 후 두 고점이 같은 레벨에서 형성 — 하락 반전',
      structure: '고점1 → 조정 → 고점2(유사 레벨) → 넥라인 이탈',
      signal: '넥라인 이탈 시 강한 하락',
      note: '두 번째 고점이 첫 번째보다 살짝 낮을수록 신뢰도 높음',
    },
    bottom: {
      desc: '하락 추세 후 두 저점이 같은 레벨에서 형성 — 상승 반전',
      structure: '저점1 → 반등 → 저점2(유사 레벨) → 넥라인 돌파',
      signal: '넥라인 돌파 시 강한 상승',
      note: '두 번째 저점이 첫 번째보다 살짝 높을수록 신뢰도 높음',
    },
  }
  const cur = data[tab]
  ...
  const TopSVG = () => (
    <svg width="72" height="60" viewBox="0 0 72 60" fill="none">
      <polyline points="4,54 16,22 28,54 40,22 52,54" fill="none" stroke={RED} strokeWidth="1.8"/>
      <line x1="4" y1="22" x2="52" y2="22" stroke={RED} strokeWidth="1" strokeDasharray="3 2" opacity="0.7"/>
      <line x1="4" y1="54" x2="68" y2="54" stroke={GRAY} strokeWidth="1" strokeDasharray="3 2" opacity="0.5"/>
      <line x1="52" y1="54" x2="64" y2="66" stroke={RED} strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  )
  const BottomSVG = () => (
    <svg width="72" height="60" viewBox="0 0 72 60" fill="none">
      <polyline points="4,8 16,42 28,8 40,42 52,8" fill="none" stroke={GREEN} strokeWidth="1.8"/>
      <line x1="4" y1="42" x2="52" y2="42" stroke={GREEN} strokeWidth="1" strokeDasharray="3 2" opacity="0.7"/>
      <line x1="4" y1="8" x2="68" y2="8" stroke={GRAY} strokeWidth="1" strokeDasharray="3 2" opacity="0.5"/>
      <line x1="52" y1="8" x2="64" y2="-4" stroke={GREEN} strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  )
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{background:'rgba(0,0,0,0.6)'}} onClick={onClose}>
      <div className={`w-full max-w-lg rounded-2xl border p-6 ${bgC} max-h-[90vh] overflow-y-auto`} onClick={e => e.stopPropagation()}>
        <div className="flex items-start justify-between mb-4">
          <div>
            <h2 className="text-lg font-semibold">더블탑 / 더블바텀</h2>
            <div className="flex items-center gap-2 mt-1">
              <span className={`text-xs ${muted}`}>반전 패턴</span>
        ...
        <div className="flex gap-2 mb-4">
          <button onClick={() => setTab('top')} className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${tab === 'top' ? tabActiveD : tabInactive}`}>더블탑 (하락)</button>
          <button onClick={() => setTab('bottom')} className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${tab === 'bottom' ? tabActiveU : tabInactive}`}>더블바텀 (상승)</button>
        </div>

        <div className={`flex gap-4 p-4 rounded-xl mb-4 ${rowBg}`}>
          <div className="shrink-0 flex items-center">
            {tab === 'top' ? <TopSVG /> : <BottomSVG />}
          </div>
          <div className="flex-1 space-y-2">
            {[['설명', cur.desc], ['구조', cur.structure], ['신호', cur.signal], ['참고', cur.note]].map(([label, val]) => (
              <div key={label} className="flex gap-2 text-xs">
                <span className={`${muted} min-w-[28px] shrink-0`}>{label}</span>
                <span className={label === '참고' ? muted : ''}>{val}</span>
              </div>
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          {['더블탑','더블바텀','이중천장','이중바닥','W형','M형'].map(k => (
            <span key={k} className={`text-xs px-2 py-0.5 rounded-full border ${dark ? 'bg-white/5 border-white/10 text-[#7a7f94]' : 'bg-black/5 border-black/10 text-gray-500'}`}>{k}</span>
          ))}
        </div>
        <ChartNote page="channel" section={`doubletb_${tab}`} />
      </div>
    </div>
  )
}
...
export default function ChannelPatterns() {
  ...
  return (
    <div>
      ...
      {selected?.name === '하락 쐐기' && <WedgeModal item={selected} onClose={() => setSelected(null)} />}
      {selected?.name === '상승 쐐기' && <WedgeModal item={selected} onClose={() => setSelected(null)} />}
      {selected?.name === '더블탑 / 더블바텀' && <DoubleTBModal onClose={() => setSelected(null)} />}
      {selected && !['하락 쐐기','상승 쐐기','더블탑 / 더블바텀'].includes(selected.name) && (
