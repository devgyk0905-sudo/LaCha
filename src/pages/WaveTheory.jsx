    ...
    <div className="mt-4 mb-2">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <svg width="100%" height="170" viewBox="0 0 280 163" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          <svg width="100%" height="170" viewBox="0 0 327 190" fill="none" xmlns="http://www.w3.org/2000/svg">
