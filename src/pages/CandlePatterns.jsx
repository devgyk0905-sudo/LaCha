...
const CANDLES = [
  ...
  { id:14, cat:'레일로드 트랙 패턴', name:'레일로드 트랙', signal:'neutral', desc:'추후 추가 예정', shape:'—', signalText:'—', note:'수업 내용 업데이트 후 추가', keywords:['레일로드트랙','로드트랙','railroad track'] },
]
...
function CandleSVG({ name }) {
  ...
  const shapes = {
    ...
    '이브닝스타': <><rect x="4"  y="28" width="12" height="24" fill={GREEN} rx="1"/><line x1="10" y1="22" x2="10" y2="28" stroke={GREEN} strokeWidth="1.5"/><rect x="28" y="22" width="8"  height="6"  fill={GRAY}  rx="1"/><line x1="32" y1="16" x2="32" y2="22" stroke={GRAY}  strokeWidth="1.5"/><line x1="32" y1="28" x2="32" y2="34" stroke={GRAY}  strokeWidth="1.5"/><rect x="50" y="10" width="14" height="26" fill={RED}   rx="1"/><line x1="57" y1="36" x2="57" y2="44" stroke={RED}   strokeWidth="1.5"/></>,
    ...
    '하락다람쥐': <>
      <rect x="2"  y="16" width="12" height="28" fill={GREEN} rx="1"/>
      <rect x="18" y="8"  width="14" height="36" fill={RED}   rx="1"/>
      <line x1="10" y1="10" x2="10" y2="16" stroke={GREEN} strokeWidth="1.5"/>
      <line x1="25" y1="4"  x2="25" y2="8"  stroke={RED}   strokeWidth="1.5"/>
      <rect x="36" y="36" width="8" height="6" fill={GRAY} rx="1"/>
      <line x1="40" y1="30" x2="40" y2="36" stroke={GRAY} strokeWidth="1.5"/>
      <line x1="40" y1="42" x2="40" y2="48" stroke={GRAY} strokeWidth="1.5"/>
      <rect x="52" y="38" width="8" height="6" fill={GRAY} rx="1"/>
      <line x1="56" y1="32" x2="56" y2="38" stroke={GRAY} strokeWidth="1.5"/>
      <line x1="56" y1="44" x2="56" y2="62" stroke={RED}  strokeWidth="1.5"/>
    </>,
    '상승다람쥐': <>
      <rect x="2"  y="10" width="12" height="36" fill={RED}   rx="1"/>
      <rect x="18" y="18" width="14" height="28" fill={GREEN} rx="1"/>
      <line x1="10" y1="46" x2="10" y2="52" stroke={RED}   strokeWidth="1.5"/>
      <line x1="25" y1="14" x2="25" y2="18" stroke={GREEN} strokeWidth="1.5"/>
      <rect x="36" y="34" width="8" height="6" fill={GRAY} rx="1"/>
      <line x1="40" y1="28" x2="40" y2="34" stroke={GRAY} strokeWidth="1.5"/>
      <line x1="40" y1="40" x2="40" y2="46" stroke={GRAY} strokeWidth="1.5"/>
      <line x1="56" y1="8"  x2="56" y2="24" stroke={GREEN} strokeWidth="1.5"/>
      <rect x="52" y="24" width="8" height="20" fill={GREEN} rx="1"/>
    </>,
    '레일로드 트랙': <><line x1="32" y1="10" x2="32" y2="54" stroke={GRAY} strokeWidth="1.5" strokeDasharray="3 2"/><text x="32" y="38" textAnchor="middle" fill={GRAY} fontSize="9">추후</text></>,
  }
  const wide = ['모닝스타','이브닝스타','백삼병','흑삼병','하락다람쥐','상승다람쥐'].includes(name)
  const w = wide ? w3 : 64
  return (
